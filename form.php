...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="1.jpg" style="width:100%; height:350px;">      
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    <li><a href="index.php">HOTEL ELİZA</a></li>
                    <li><a href="odalar.php">ODALAR</a></li>
                    <li class="active"><a href="reservation.php">Online Rezervasyon</a></li>
       ...
       <div class='row'>
        ...
        <div class='col-md-5 well'>
         <form action="" method="post" name="room_category">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" class="btn btn-primary button" name="submit">Müsaitlik Durumu Kontrol Et</button>
